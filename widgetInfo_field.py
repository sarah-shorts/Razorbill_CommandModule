...
guiFields = {
    ...
    "openingtext": {
        ...
        "label": 'Ma\'ii is a very basic assistant programmed to help control the operation of the Razorbill strain \n'+
                 'cell when installed within a Quantum Design PPMS. By setting the field/voltage parameters \n'+
                 'a simple experiment can be run that cycles the field while iteratively increasing the strain.',
        "units": '',
        "stats": '',
        "color": blk,
        "bounds": ['n/a', 'n/a'],
