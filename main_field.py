    ...
    def monitor_determine_state(self):
        ...
        if mode == "Ramp" or mode == "Hold":
            try:
                ...
                elif self.D3.field_status == "Stable" and ((fmin+ftol) >= self.D3.field >= (fmin-ftol)):
                ...
                elif self.D3.field_status == "Stable" and ((fmax+ftol) >= self.D3.field >= (fmax-ftol)):
                ...
                elif self.D3.field_status in ["Stable", "Ramping", "Iterating"]:
            ...
            try:
                ...
                # if we have a stable field and we're within tolerance to f_min1, we're in the Ready1 state.
                    ...
                    self.monDict["measureStatus"].update({"value": "Ma'ii is in the READY1 state. \n"
                                                                   ...
                                                                   "and begin a new field ramp profile."})
                # if we have a stable field and we're within tolerance to f_min1, we're in the Ready1 state.
                elif self.D3.field_status == "Stable" and ((fmin2 + ftol) >= self.D3.field >= (fmin2 - ftol)):
                    ...
                    self.monDict["measureStatus"].update({"value": "Ma'ii is in the READY2 state. \n"
                                                                   ...
                                                                   "and begin a new field ramp profile."})
                # if we have a stable field and we're within tolerance to f_max, we're in the Finished state.
                elif self.D3.field_status == "Stable" and ((fmax + ftol) >= self.D3.temp >= (fmax - ftol)):
                ...
                # if we have a stable field and we're within tolerance to f_max, we're in the Finished state.
                elif self.D3.field_status == "Stable" and ((fmax2 + ftol) >= self.D3.temp >= (fmax2 - ftol)):
